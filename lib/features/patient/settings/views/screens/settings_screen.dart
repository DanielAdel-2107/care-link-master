...
import 'package:care_link/features/doctor/profile/views/screens/doctor_profile_screen.dart';
        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              getIt<CacheHelper>().getDoctorModel() == null
                  ? _SettingsTile(
              ...
              _SettingsTile(
                ...
                onTap: () {
                  final email =
                      getIt<CacheHelper>().getPatientModel()?.patient?.email ??
                          '';
                  Navigator.push(
                    context,
                    MaterialPageRoute(
